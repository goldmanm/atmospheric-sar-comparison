...
from orlando2003 import sar
from orlando2003 import get_ionization_potential, get_IP_of_reaction
...
""")])]], family='R_Addition_MultipleBond', template=['Cd_R', 'CsJ'])
    ...
    def test_get_arrhenius(self):
        ...
        self.assertAlmostEqual(rate.Ea.value,2.4*self.methyl_ip-11.8+0.58*13.1,places=1)
    ...
    def test_get_rate(self):
        ...
        #self.assertAlmostEqual(rate,3.4,places=0) # make sure the rate is similar to in paper
